...
import { InvoicesByMatter } from '../Invoices/InvoicesByMatter';
const LastWeekBillingsByAttorney: React.FC = () => {

    const [matterData, setMatterData] = useState<InvoicesByMatter[][]>();

    const getData = () => {
        axios.get('https://localhost:44318/api/Invoice/BillingsByAttorney')
            .then(res => {
...
export default LastWeekBillingsByAttorney;
